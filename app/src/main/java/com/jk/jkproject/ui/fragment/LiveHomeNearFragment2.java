...
public class LiveHomeNearFragment2 extends BFragment implements RefreshRecyclerViewListener {
    ...
    public void getData(int paramInt) {
        AppApis.getHomeNearData(paramInt, 2, this);
    }

    public static LiveHomeNearFragment2 newInstance(int paramInt) {
        LiveHomeNearFragment2 liveHomeNearFragment = new LiveHomeNearFragment2();
                ...
                if (size > 0) {
                    for (int i = 0; i < size; i++) {
                        ...
                        for (int j = 0; j < mAdapter.getList().size(); j++) {
                            ...
                            if (dataBean.getU_id().equals(dataBean2.getU_id())) {
                                addResult = false;
                                break;
                            }
                        }
