...
public class RoundCircleProgressBar extends View {
    ...
    public RoundCircleProgressBar(Context context) {
        this(context, null);
    }

    public RoundCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundCircleProgressBar);

        mLineCount = a.getInt(R.styleable.RoundCircleProgressBar_line_count, DEFAULT_LINE_COUNT);

        mStyle = a.getInt(R.styleable.RoundCircleProgressBar_style, LINE);
        mShader = a.getInt(R.styleable.RoundCircleProgressBar_progress_shader, LINEAR);
        mCap = a.hasValue(R.styleable.RoundCircleProgressBar_progress_stroke_cap) ?
                Paint.Cap.values()[a.getInt(R.styleable.RoundCircleProgressBar_progress_stroke_cap, 0)] : Paint.Cap.BUTT;

        mLineWidth = a.getDimensionPixelSize(R.styleable.RoundCircleProgressBar_line_width, ScreenUtils.dp2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.RoundCircleProgressBar_progress_textSize, ScreenUtils.dp2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.RoundCircleProgressBar_progress_stroke_width, ScreenUtils.dp2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));

        mProgressStartColor = a.getColor(R.styleable.RoundCircleProgressBar_progress_start_color, Color.parseColor(COLOR_FFF2A670));
        mProgressEndColor = a.getColor(R.styleable.RoundCircleProgressBar_progress_end_color, Color.parseColor(COLOR_FFF2A670));
        mProgressTextColor = a.getColor(R.styleable.RoundCircleProgressBar_progress_textColor, Color.parseColor(COLOR_FFF2A670));
        mProgressBackgroundColor = a.getColor(R.styleable.RoundCircleProgressBar_progress_background_color, Color.parseColor(COLOR_FFD3D3D5));

        mStartDegree = a.getInt(R.styleable.RoundCircleProgressBar_progress_start_degree, DEFAULT_START_DEGREE);
        mDrawBackgroundOutsideProgress = a.getBoolean(R.styleable.RoundCircleProgressBar_drawBackgroundOutsideProgress, false);
    ...
    private void drawSolidLineProgress(Canvas paramCanvas) {
        if (this.mDrawBackgroundOutsideProgress) {
            float f = this.mProgress * 360.0F / this.mMax;
            paramCanvas.drawArc(this.mProgressRectF, f, 360.0F - f, false, this.mProgressBackgroundPaint);
        } else {
            paramCanvas.drawArc(this.mProgressRectF, 0.0F, 360.0F, false, this.mProgressBackgroundPaint);
        }
        paramCanvas.drawArc(this.mProgressRectF, 360.0F, 1.0F - this.mProgress * 360.0F / this.mMax, false, this.mProgressPaint);
    }

    private void drawSolidProgress(Canvas paramCanvas) {
        if (this.mDrawBackgroundOutsideProgress) {
            float f = this.mProgress * 360.0F / this.mMax;
            paramCanvas.drawArc(this.mProgressRectF, f, 360.0F - f, true, this.mProgressBackgroundPaint);
        } else {
            paramCanvas.drawArc(this.mProgressRectF, 0.0F, 360.0F, true, this.mProgressBackgroundPaint);
        }
        paramCanvas.drawArc(this.mProgressRectF, 360.0F, 1.0F - this.mProgress * 360.0F / this.mMax, true, this.mProgressPaint);
    }
