...
class SimpleMultipartEntity implements HttpEntity {
	...
	private byte[] createContentType(String type) {
		String result = AsyncHttpClient.HEADER_CONTENT_TYPE + ": "
				+ normalizeContentType(type) + STR_CR_LF;
	...
	private class FilePart {
		...
		public FilePart(String key, File file, String type,
			...
			header = createHeader(key,
					TextUtils.isEmpty(customFileName) ? file.getName()
							: customFileName, type);
			this.file = file;
		}
	...
	public Header getContentType() {
		return new BasicHeader(AsyncHttpClient.HEADER_CONTENT_TYPE,
