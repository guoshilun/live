package com.fansan.common.network.interceptor.logging;
...
import com.fansan.common.utils.CharacterHandler;
import com.fansan.common.utils.LogUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
    private static final String TAG = "fansangg -- HttpLog";
