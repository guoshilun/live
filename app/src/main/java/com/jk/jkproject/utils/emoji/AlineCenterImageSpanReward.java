...
public class AlineCenterImageSpanReward extends ImageSpan {
  ...
  public AlineCenterImageSpanReward(Context paramContext, int paramInt) {
    super(paramContext, paramInt);
    this.mContext = paramContext;
    this.mResourceId = paramInt;
  }
  
  public AlineCenterImageSpanReward(Context paramContext, int paramInt1, int paramInt2) {
