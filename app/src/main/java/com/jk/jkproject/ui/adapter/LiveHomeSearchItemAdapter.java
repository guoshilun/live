...
public class LiveHomeSearchItemAdapter extends BaseWrapperRecyclerAdapter<LiveHomeBeanInfo.DataBean, LiveHomeSearchItemAdapter.ItemViewHolder> {
    ...
    public LiveHomeSearchItemAdapter(Context paramContext, List<LiveHomeBeanInfo.DataBean> paramList) {
