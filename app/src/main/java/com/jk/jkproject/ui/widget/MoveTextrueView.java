...
public class MoveTextrueView extends TextureView {
    ...
    public MoveTextrueView(Context context) {
        super(context);
    ...
    public MoveTextrueView(Context context, AttributeSet attrs) {
        super(context, attrs);
        getScreenInformation(context);
    }

    public MoveTextrueView(Context context, AttributeSet attrs, int defStyle) {
