 ...
 * @desc 对方PK贡献榜
 */
public class LiveHomePKContribution2Fragment extends BFragment implements RefreshRecyclerViewListener {
    ...
    public void getData(int page) {
        LogUtils.e("===========", tagUserId + "======" + tagRoomId + "=====" + pkId);
        AppApis.getPKContribution(page, tagUserId, pkId, tagRoomId, this);
    }

    public void getData(String pkId, String tagUserId, String tagRoomId) {
        this.pkId = pkId;
    ...
    public static LiveHomePKContribution2Fragment newInstance(int paramInt) {
        LiveHomePKContribution2Fragment liveHomeNearFragment = new LiveHomePKContribution2Fragment();
