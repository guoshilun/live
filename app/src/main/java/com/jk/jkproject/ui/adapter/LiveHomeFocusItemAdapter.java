...
public class LiveHomeFocusItemAdapter extends BaseWrapperRecyclerAdapter<LiveHomeBeanInfo.DataBean, LiveHomeFocusItemAdapter.ItemViewHolder> {
    ...
    public LiveHomeFocusItemAdapter(Context paramContext, List<LiveHomeBeanInfo.DataBean> paramList) {
...
//            adverPic.setHierarchy(hierarchy);
            ...
            paramItemViewHolder.rl2.setOnClickListener(v -> {
                if (onItemClickListener != null && FastClickUtils.isFastClick()) {
