...
public class BlackListAdapter extends BaseWrapperRecyclerAdapter<BlackList.DataBean, BlackListAdapter.ItemViewHolder> {
    ...
    public BlackListAdapter(Context paramContext, List<BlackList.DataBean> paramList) {
    ...
    public void onBindItemViewHolder(ItemViewHolder viewHolder, int position) {
        ...
        if (list.size() > 0) {
            ...
            viewHolder.tvUserName.setTextColor(context.getResources().getColor(R.color.color_333));
            viewHolder.tvUserSign.setText(dataBean.getSgin());
            viewHolder.tvUserSign.setTextColor(context.getResources().getColor(R.color.color_999));
            ...
            viewHolder.tvCancel.setOnClickListener(param1View -> {
