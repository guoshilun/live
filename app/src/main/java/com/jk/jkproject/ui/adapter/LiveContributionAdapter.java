 ...
 * @desc 榜单适配器
 */
public class LiveContributionAdapter extends BaseWrapperRecyclerAdapter<FanContributionList.DataBean, LiveContributionAdapter.ItemViewHolder> implements OnRecyclerItemClickListener {
    ...
    public LiveContributionAdapter(Context paramContext, List<FanContributionList.DataBean> paramList, int position) {
    ...
    public void onBindItemViewHolder(ItemViewHolder paramItemViewHolder, int position) {
        ...
        if (list.size() > 0) {
            ...
            paramItemViewHolder.tvHotCount.setText(dataBean.getSum_amount() + "钻石");
