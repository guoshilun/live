...
import com.jk.jkproject.ui.entity.LiveGiftInfo;
...
public class PageRecyclerView extends RecyclerView {
    ...
    private void defaultInit(Context context) {
        ...
        setLayoutManager(new AutoGridViewManager(
                mContext, spanRow, AutoGridViewManager.HORIZONTAL, false));
    ...
    public void setPageSize(int spanRow, int spanColumn) {
        ...
        setLayoutManager(new AutoGridViewManager(
                mContext, this.spanRow, AutoGridViewManager.HORIZONTAL, false));
    }
    ...
    public class PageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private List<LiveGiftInfo> dataList = null;
         ...
         * @param callBack
         */
        public PageAdapter(List<LiveGiftInfo> data, CallBack callBack) {
            this.dataList = data;
