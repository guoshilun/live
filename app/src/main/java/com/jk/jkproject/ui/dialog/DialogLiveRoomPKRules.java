 ...
 * @desc pk规则
 */
public class DialogLiveRoomPKRules extends BaseDialog {
    ...
    public DialogLiveRoomPKRules(Context paramContext, int mType) {
        super(paramContext);
    ...
    protected void create(Bundle paramBundle) {
        setContentView(R.layout.dialog_live_room_pk_rules);
...
//        web.loadUrl("http://192.168.0.188:8089/#/pages/top/top");
        ...
        web.loadUrl(getH5Page(Urls.PK_RULES));
