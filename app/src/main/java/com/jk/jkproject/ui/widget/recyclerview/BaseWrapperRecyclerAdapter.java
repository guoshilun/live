...
public abstract class BaseWrapperRecyclerAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter {
    ...
    public static final int CONTENT_VIEW_TYPE_OFFSET = FOOTER_LOAD_MORE_VIEW_TYPE + VIEW_TYPE_MAX_COUNT;
...
//                if (position == 0){
//                    Log.i("123","cccccccccccccc");
//                    return HEADER_VIEW_ITEM_LAYOUT_TOP_ONE;
//                }
//                else if(position == 1 || position == 2){
//                    Log.i("123","ddddddddddddddddd");
//                    return HEADER_VIEW_ITEM_LAYOUT_OTHER;
//                }
...
//                }
    ...
    public void add(int position, T t, boolean notifyDataChange) {
        if (t == null) {
            return;
        }
        mItemList.add(position,t);
        if (notifyDataChange) {
            try {
                notifyItemInserted(mHeaderSize + getBasicItemCount());
            } catch (Exception e) {
