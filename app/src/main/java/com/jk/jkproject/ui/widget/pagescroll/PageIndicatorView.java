...
public class PageIndicatorView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        dotSize = ScreenUtils.dp2px(context, dotSize);
        margins = ScreenUtils.dp2px(context, margins);
    }
    ...
    public void initIndicator(int count) {
        ...
        if (indicatorViews.size() > 0) {
            indicatorViews.get(0).setBackgroundResource(R.drawable.dot_select);
        }
    }
    ...
    public void setSelectedPage(int selected) {
        for (int i = 0; i < indicatorViews.size(); i++) {
            if (i == selected) {
                indicatorViews.get(i).setBackgroundResource(R.drawable.dot_select);
            } else {
                indicatorViews.get(i).setBackgroundResource(R.drawable.dot_normal);
            }
        }
    }
